...
export function ProfessionalWhatsAppButton() {
  ...
  const message = "Olá! Vim pelo site e gostaria de falar com um advogado especialista em direito bancário.";
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      ...
      <div className="relative">
        ...
        <div className="absolute inset-0 rounded-full border-2 border-green-300/20 animate-ping" style={{ animationDelay: '0.5s' }}></div>
        ...
        >
          <div className="bg-white text-gray-800 px-4 py-3 rounded-xl shadow-2xl border border-gray-200 whitespace-nowrap max-w-xs">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <p className="text-sm font-bold text-gray-900">Atendimento Especializado</p>
